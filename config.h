 ...
 */
static const char *fonts[]     = {"Hack Nerd Font:style=Bold:size=10:antialias=true:autohint=true",
  "JoyPixels:size=12:antialias=true:autohint=true"
};
static const char col_1[]  = "#222222"; /* background color of bar */
static const char col_2[]  = "#282c34"; /* border color unfocused windows */
static const char col_3[]  = "#d7d7d7";
static const char col_4[]  = "#005577"; /* border color focused windows and tags */
/* bar opacity
...
static Key keys[] = {
  ...
  { MODKEY,               -1,        XK_Print,      spawn,          CMD("/home/gotar/.local/bin/dmscrot") },
